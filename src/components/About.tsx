// A página "Sobre": o que o app treina, em que ajuda, como tirar proveito, a família e os
// créditos. Todo o texto mora na i18n (`about.*`); aqui fica só a forma, igual em todos os apps.

import { ArrowLeft, ArrowLeftRight, BookOpen, Headphones, Layers, SlidersHorizontal, Target } from 'lucide-react'
import { useTranslation } from 'react-i18next'
import logoUrl from '../assets/brand/icon.svg'

/** um ícone por item de `about.helps`, na mesma ordem */
const HELP_ICONS = [ArrowLeftRight, Layers, Target, BookOpen, Headphones, SlidersHorizontal]
      ...
      <article className="mx-auto flex max-w-2xl flex-col gap-10 px-4 py-8 sm:py-12">
        ...
        <section className="flex flex-col gap-4">
          ...
          <ul className="grid gap-x-6 gap-y-5 sm:grid-cols-2">
            {helps.map((h, i) => {
              const Icon = HELP_ICONS[i] ?? Target
              return (
